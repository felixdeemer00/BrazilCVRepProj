...
Do you have an introduction that summarizes the original paper and gives an
overview of your replication:
a) What question(s) did author(s) ask?  
b) What analysis did they run?
c) What did they conclude?

–What did you do in the replication and what can you conclude?  
What models  did  you  use?   What  did  you  (try  to)  extend?   
What  are  the implications?
–Think of your report as a standalone report without requiring the readers
to be familiar with the original paper.
...
levels were used as a proxy for wealth and privilege).
...
threshold (explained in detail below)
...
Do you discuss what aspects of the paper you were able to replicate and which
parts, if any, you were not able to replicate?
