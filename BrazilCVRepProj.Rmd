...
I then attempted to decide what bandwidth to use by analyzing how the final
estimate of the CV causal effect varied by bandwidth for each group. I created
a function to calculate and return the estimate of the CV causal effect, as well
as the 95% confidence interval (calculated using the standard errors of the 
intercept coefficients from the individual models). I then plotted a graph 
showing how the estimated effect changes as the bandwidth increases, for every 
bandwidth between 15 days and 365 days. These results are shown in the graph 
below, with the solid line showing the point estimate and the dashed lines 
...
data points are being fed into the linear models. 
...
[Explanation of Final 69-70 Coefficient]
...
[Explanation of Unregistered Voter Estimate]
...
[Explanation of Final 17-18 Coefficient]
